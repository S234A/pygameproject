...
class Snake():
    ...
    def validate_direction_and_change(self):
        if any((self.movement == 'RIGHT' and not self.direction == 'LEFT',
                self.movement == 'LEFT' and not self.direction == 'RIGHT',
                self.movement == 'UP' and not self.direction == 'DOWN',
                self.movement == 'DOWN' and not self.direction == 'UP')):
...
while True:
    snake.movement = game.event_loop(snake.movement)
